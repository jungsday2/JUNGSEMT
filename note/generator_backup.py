...
from ..EMT_3bus.supEMT import BaseComponent, phasor_to_3phase_at, abc_to_dq0, dq0_to_abc
...
class Generator(BaseComponent):
    def __init__(self, bus, bus_manager, dt, params=None, is_slack=False, V_mag=1.01, V_angle=0.83 * np.pi / 180):
        """
        Args:
            bus:         연결될 모선 ID
